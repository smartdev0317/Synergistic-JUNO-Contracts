...
/// This uses the Synedex CustomQuerier.
...
#[derive(Clone, Default)]
pub struct SynedexFactoryQuerier {
    pairs: HashMap<String, PairInfo>,
}

impl SynedexFactoryQuerier {
    pub fn new(pairs: &[(&String, &PairInfo)]) -> Self {
        SynedexFactoryQuerier {
...
struct DefaultQueryHandler {
    ...
    synedex_factory_querier: SynedexFactoryQuerier,
}
        ...
        match &request {
            QueryRequest::Wasm(WasmQuery::Smart {
                ...
                FactoryQueryMsg::Pair { asset_infos } => {
                    ...
                    match self.synedex_factory_querier.pairs.get(&key) {
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier<Empty>) -> Self {
        WasmMockQuerier {
            query_handler: DefaultQueryHandler {
                base,
                synedex_factory_querier: SynedexFactoryQuerier::default(),
            },
            cw20_query_handler: CW20QueryHandler {
    ...
    // Configure the synedex pair
    pub fn with_synedex_pairs(&mut self, pairs: &[(&String, &PairInfo)]) {
        self.query_handler.synedex_factory_querier = SynedexFactoryQuerier::new(pairs);
    }
