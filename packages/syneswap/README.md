# Syneswap: Common Types

This is a collection of common types and the queriers which are commonly used in syneswap contracts.
...
It also provides the query interface to query avaliable syneswap pair contract info. Any contract can query pair info to syneswap factory contract.
...
It returns liquidity token contract address of syneswap pair contract. 
